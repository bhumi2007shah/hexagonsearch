...
ALTER TABLE COMPANY_SCREENING_QUESTION ADD COLUMN QUESTION_CATEGORY VARCHAR (50);
ALTER TABLE COMPANY_SCREENING_QUESTION ADD COLUMN SCORING_TYPE VARCHAR (50);
ALTER TABLE COMPANY_SCREENING_QUESTION ADD COLUMN DEFAULT_ANSWERS VARCHAR (150)[];
ALTER TABLE COMPANY_SCREENING_QUESTION ADD COLUMN ANSWER_SELECTION VARCHAR (50);
ALTER TABLE COMPANY_SCREENING_QUESTION ADD COLUMN QUESTION_TAG VARCHAR (50);
ALTER TABLE COMPANY_SCREENING_QUESTION ADD COLUMN QUESTION_SEQ VARCHAR (50);
ALTER TABLE COMPANY_SCREENING_QUESTION ADD COLUMN QUESTION_OWNER_SEQ VARCHAR (50);